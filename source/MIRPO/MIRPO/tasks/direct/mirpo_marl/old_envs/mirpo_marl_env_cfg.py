...
class MirpoMarlEnvCfg(DirectMARLEnvCfg):
    ...
    # Each agent has linear force on x and y axis 
    action_spaces = {"agent1": 2, "agent2": 2}
    # Each agent has x & y Cartesian positions of current and goal positions.
    observation_spaces = {"agent1": 4, "agent2": 4}
    state_space = -1
